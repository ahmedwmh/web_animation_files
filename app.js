...
class CardStreamController {
  ...
  generateCode(width, height) {
    ...
    const header = [
      "منصة ذا مايند التعليمية (The Mind Platform) هي منصة تعليمية إلكترونية.",
      "منصة ذا مايند التعليمية (The Mind Platform) هي منصة تعليمية إلكترونية.",,
      "توفر المنصة دورات عالية الجودة في مختلف المجالات.",
      "تعتبر المنصة شريكك الموثوق في رحلة التعلم والتطوير المستمر.",
      "The Mind Platform (منصة ذا مايند التعليمية) is an educational platform operating as a reliable partner in the journey of learning and development.",
      "The Mind Platform (منصة ذا مايند التعليمية) is an educational platform operating as a reliable partner in the journey of learning and development.",
    ];
  ...
  createCardWrapper(index) {
    ...
    const cardImages = [
      "https://qninjbugtddiclxydpki.supabase.co/storage/v1/object/public/themind/1753265265736_theme.jpg",
      "https://qninjbugtddiclxydpki.supabase.co/storage/v1/object/public/themind/1753524195891_course_gd.png",
      "https://qninjbugtddiclxydpki.supabase.co/storage/v1/object/public/themind/1752429955417_photo_2025_07_13_20.30.00.png",
      "https://qninjbugtddiclxydpki.supabase.co/storage/v1/object/public/themind/1753773415733_Add_a_heading.png",
      "https://qninjbugtddiclxydpki.supabase.co/storage/v1/object/public/themind/1757858566629____________.jpg",
    ];
...
class ParticleScanner {
  ...
  drawLightBar() {
    ...
    if (this.scanningActive) {
      ...
      glow3Gradient.addColorStop(0.5, "rgba(110, 246, 92, 0.2)");
